        ...
        if (player.id == idavg) {
            ...
            while (finn >> playerData[rows][0].data.id >> playerData[rows][1].matches >> playerData[rows][2].runs >> playerData[rows][3].sixes) {
                if (idavg == player.id && idavg == playerData[rows][0].data.id) {
                    ...
                    cout << player.id << "\t" << setw(10) << player.name << "\t" << setw(10) << player.team << "\t" << setw(10) << player.role << setw(10)<<"Data in file 1" << endl;
                    cout << playerData[rows][0].data.id << "\t" << setw(10) << playerData[rows][1].matches << "\t" << setw(10) << playerData[rows][2].runs << "\t" << setw(10) << playerData[rows][3].sixes << setw(10) << "Data in file 2" << endl;
                    cout << "Match found" << endl;
